...
const MondayJune10thPosters = () => {
  return (
    <div>
      <div className="mj10-list">
        <ul className="mj10-inner-list">
          <li>
            Jeon Mi Lee, Hyun Jin Lee, Gilmoon Lee and Jae-jin Song, Auditory
          ...
          <li>
            ...
            Kamalakannan Karupaiah 3 , Prashanth Prabhu, Prevalence of
...
export default MondayJune10thPosters;
